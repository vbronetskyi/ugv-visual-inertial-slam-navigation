...
def generate_launch_description():
    config = "/workspace/simulation/isaac/routes/15_wmid_smid/repeat/config/nav2_planner_only.yaml"
    map_yaml = "/root/isaac_tr_datasets/15_wmid_smid/teach/teach_outputs/teach_map.yaml"
