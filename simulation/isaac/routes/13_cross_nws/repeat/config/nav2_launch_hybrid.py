...
def generate_launch_description():
    config = "/workspace/simulation/isaac/routes/13_cross_nws/repeat/config/nav2_planner_only.yaml"
    map_yaml = "/root/isaac_tr_datasets/13_cross_nws/teach/teach_outputs/teach_map.yaml"
