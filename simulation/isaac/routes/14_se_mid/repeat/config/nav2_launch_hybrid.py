...
def generate_launch_description():
    config = "/workspace/simulation/isaac/routes/14_se_mid/repeat/config/nav2_planner_only.yaml"
    map_yaml = "/root/isaac_tr_datasets/14_se_mid/teach/teach_outputs/teach_map.yaml"
